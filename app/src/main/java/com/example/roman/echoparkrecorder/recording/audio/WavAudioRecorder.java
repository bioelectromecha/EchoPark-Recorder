...
public class WavAudioRecorder {
    public final static int[] sampleRates = {44100, 22050, 11025, 8000};

    /**
     * get a WavAudioRecorder instance
     * @return WavAudioRecorder instance
     */
    public static WavAudioRecorder getInstance() {
        // note samples rate and audio source are hardcoded
